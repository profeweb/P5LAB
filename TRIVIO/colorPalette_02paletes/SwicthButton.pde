...
class SwitchButton {
 ...
 void display(){
   ...
   if(this.enabled){
     rect(this.x + this.w/3, this.y + this.h/2, this.w/2, this.h-10, 5);
     fill(0);
     text("Light", this.x + this.w/3, this.y + this.h/2 + 10);
   }
   else {
     rect(this.x + this.w - this.w/3, this.y + this.h/2, this.w/2, this.h-10, 5);
     fill(0);
     text("Dark", this.x + this.w - this.w/3, this.y + this.h/2 + 10);
   }
