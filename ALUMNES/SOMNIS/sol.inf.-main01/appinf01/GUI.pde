...
Calendari c;
SwitchButton b1, b2;
Select selCategoria, s2, selUsuario, s4;
BarsDiagram s;
...
void initSelect() {
  String[] selectValues = getNomsCategories();
  String[] selectValues2 = {"1", "2", "3", "4", "5", "6", "7", "8"};
  String[] selectValues3 = getEmailsUsuaris();
  ...
  selCategoria = new Select(selectValues, 1200, 275, selectW, selectH);
  s2= new Select(selectValues2, logoWidth+pageWidth/11, pageHeight/10+20, selectW2, selectH2);
  selUsuario= new Select(selectValues3, width/5, height/10*2, selectW2, selectH2);
